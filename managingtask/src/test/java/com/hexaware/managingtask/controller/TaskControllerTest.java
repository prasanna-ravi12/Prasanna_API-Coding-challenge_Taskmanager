...
public class TaskControllerTest {
    ...
    public void setUp() {
        ...
        sampleTask = new Task(null, "Test Task", "This is a test", LocalDate.now().plusDays(1), null, Priority.HIGH, Status.PENDING);
        sampleTask.setId(1L);
    }
    ...
    public void testUpdateTaskFound() {
        Task updatedTask = new Task(null, "Updated Task", "Updated description", LocalDate.now().plusDays(2), null, Priority.MEDIUM, Status.IN_PROGRESS);
